  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-xl md:text-4xl font-medium",
        ...
        head_row: "flex md:gap-4",
        head_cell:
          "text-zinc-500 rounded-md w-8 font-normal md:text-2xl dark:text-zinc-400",
        row: "flex w-full md:gap-4 mt-2",
        cell: cn(
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 md:text-xl"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "bg-zinc-900 text-white hover:bg-zinc-900 hover:text-zinc-50 focus:bg-zinc-900 focus:text-white dark:bg-zinc-50 dark:text-white dark:hover:bg-zinc-50 dark:hover:text-white dark:focus:bg-zinc-50 dark:focus:text-white",
      ...
      components={{
        IconLeft: () => <ChevronLeftIcon className="h-2 w-2 md:h-4 md:w-4" />,
        IconRight: () => <ChevronRightIcon className="h-2 w-2 md:h-4 md:w-4" />,
      }}
      {...props}
    />
  )
